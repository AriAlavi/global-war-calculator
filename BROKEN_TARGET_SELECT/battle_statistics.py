...
def simulate_battle_results(attackers: List[Unit], defenders: List[Unit], terrain:Terrain, n:int=5_000) -> float:
    """
...
def compare_armies_in_terrain(side_1: List[Unit], side_2: List[Unit], terrain: Terrain, n:int=10_000) -> float:
    """
